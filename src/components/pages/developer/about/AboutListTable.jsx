...
import { setArchive, setDelete, setRestore } from "../../../../../store/StoreAction";
...
const AboutListTable = ({ setItemEdit, setIsModal }) => {
  ...
  return (
    <>
      ...
      {store.archive && (
        <ModalArchive
          endpoint={`/rest/v1/controllers/developer/about/active.php?aboutid=${id}`}
      ...
      {store.delete && (
        <ModalDelete
          endpoint={`/rest/v1/controllers/developer/about/about.php?aboutid=${id}`}
          msg={`Are you sure want to delete this record?`}
          successMsg={`Successfully Delete.`}
          item={dataItem.about_name}
          queryKey={`about-list`}
        />
      )}
