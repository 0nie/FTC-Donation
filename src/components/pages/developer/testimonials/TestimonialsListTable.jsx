  ...
  const {
    ...
    queryFn: async ({ pageParam = 1 }) =>
      await queryDataInfinite(
        `/rest/v1/controllers/developer/testimonials/search.php`, // url search
    ...
    <>
      ...
      <div className="relative">
        ...
        <table>
          <thead>
            <tr>
              <th className="w-[3rem] text-left">#</th>
                ...
                {Array.isArray(page.data) &&
                  page.data.map((item, key) => (
                    <tr key={key} className="relative group cursor-pointer">
                      ...
                      <td>
                        {item.testimonials_first_name}{" "}
                        {item.testimonials_last_name}
                      </td>
                      <td>{item.testimonials_email}</td>
      ...
      {store.archive && (
        <ModalArchive
          endpoint={`/rest/v1/controllers/developer/testimonials/active.php?testimonialsid=${id}`}
      ...
      {store.delete && (
        <ModalDelete
          endpoint={`/rest/v1/controllers/developer/testimonials/testimonials.php?testimonialsid=${id}`}
          msg={`Are you sure want to delete this record?`}
          successMsg={`Successfully Delete.`}
          item={dataItem.testimonials_name}
          queryKey={`testimonials-list`}
        />
      )}
