...
const ChildrenListTable = ({ setItemEdit, setIsModal }) => {
  ...
  return (
    <>
      ...
      {store.archive && (
        <ModalArchive
          endpoint={`/rest/v1/controllers/developer/children-list/active.php?childrenid=${id}`}
      ...
      {store.delete && (
        <ModalDelete
          endpoint={`/rest/v1/controllers/developer/children-list/children.php?childrenid=${id}`}
